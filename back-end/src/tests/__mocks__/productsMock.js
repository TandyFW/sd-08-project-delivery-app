const productsMockDB = [
  { id: 1, name: 'oi', price: '2.20', urlImage: 'http://localhost:3001/images/skol_lata_350ml.jpg' },
...
const productByIdMockDB = { id: 7, name: 'Becks 330ml', price: '4.99', urlImage: 'http://localhost:3001/images/becks_330ml.jpg' };

const productsMockDBResponse = {
  products: productsMockDB,
};

const productByIdMockDBResponse = {
  products: productByIdMockDB,
};

module.exports = { productsMockDB, productsMockDBResponse, productByIdMockDB, productByIdMockDBResponse };
